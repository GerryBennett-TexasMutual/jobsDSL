...
job('xray_demo/xray_demo_UWApps/XRay Demo - PABSPolicyRptg') {

  	  properties {
        githubProjectUrl('file:///opt/XRayDemo/UWApps/PABSPolicyRptg')
    }
  
    scm {
    	git {
          remote {
	  	       url('file:///opt/XRayDemo/UWApps/PABSPolicyRptg')
          }
          branch('**/master')
          extensions {
                    wipeOutWorkspace()
