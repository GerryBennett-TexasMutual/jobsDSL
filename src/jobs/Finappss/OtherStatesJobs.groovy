...
job('xray_demo/xray_demo_Finappss/XRay Demo - OtherStates') {

  	  properties {
        githubProjectUrl('file:///opt/XRayDemo/Finappss/OtherStates')
    }
  
    scm {
    	git {
          remote {
	  	       url('file:///opt/XRayDemo/Finappss/OtherStates')
          }
          branch('**/master')
          extensions {
                    wipeOutWorkspace()
