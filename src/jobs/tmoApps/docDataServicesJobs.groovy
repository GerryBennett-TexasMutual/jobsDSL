...
job('xray_demo/xray_demo_tmoApps/XRay Demo - docDataServices') {

  	  properties {
        githubProjectUrl('file:///opt/XRayDemo/tmoApps/docDataServices')
    }
  
    scm {
    	git {
          remote {
	  	       url('file:///opt/XRayDemo/tmoApps/docDataServices')
          }
          branch('**/master')
          extensions {
                    wipeOutWorkspace()
