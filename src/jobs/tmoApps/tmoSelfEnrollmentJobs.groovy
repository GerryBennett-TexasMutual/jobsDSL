...
job('xray_demo/xray_demo_tmoApps/XRay Demo - tmoSelfEnrollment') {

  	  properties {
        githubProjectUrl('file:///opt/XRayDemo/tmoApps/tmoSelfEnrollment')
    }
  
    scm {
    	git {
          remote {
	  	       url('file:///opt/XRayDemo/tmoApps/tmoSelfEnrollment')
          }
          branch('**/master')
          extensions {
                    wipeOutWorkspace()
