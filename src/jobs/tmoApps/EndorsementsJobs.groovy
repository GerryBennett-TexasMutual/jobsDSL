...
job('xray_demo/xray_demo_tmoApps/XRay Demo - Endorsements') {

  	  properties {
        githubProjectUrl('file:///opt/XRayDemo/tmoApps/Endorsements')
    }
  
    scm {
    	git {
          remote {
	  	       url('file:///opt/XRayDemo/tmoApps/Endorsements')
          }
          branch('**/master')
          extensions {
                    wipeOutWorkspace()
