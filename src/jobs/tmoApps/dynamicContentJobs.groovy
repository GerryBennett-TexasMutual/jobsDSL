...
job('xray_demo/xray_demo_tmoApps/XRay Demo - dynamicContent') {

  	  properties {
        githubProjectUrl('file:///opt/XRayDemo/tmoApps/dynamicContent')
    }
  
    scm {
    	git {
          remote {
	  	       url('file:///opt/XRayDemo/tmoApps/dynamicContent')
          }
          branch('**/master')
          extensions {
                    wipeOutWorkspace()
