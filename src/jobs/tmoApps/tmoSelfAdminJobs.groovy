...
job('xray_demo/xray_demo_tmoApps/XRay Demo - tmoSelfAdmin') {

  	  properties {
        githubProjectUrl('file:///opt/XRayDemo/tmoApps/tmoSelfAdmin')
    }
  
    scm {
    	git {
          remote {
	  	       url('file:///opt/XRayDemo/tmoApps/tmoSelfAdmin')
          }
          branch('**/master')
          extensions {
                    wipeOutWorkspace()
