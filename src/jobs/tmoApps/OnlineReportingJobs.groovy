...
job('xray_demo/xray_demo_tmoApps/XRay Demo - OnlineReporting') {

  	  properties {
        githubProjectUrl('file:///opt/XRayDemo/tmoApps/OnlineReporting')
    }
  
    scm {
    	git {
          remote {
	  	       url('file:///opt/XRayDemo/tmoApps/OnlineReporting')
          }
          branch('**/master')
          extensions {
                    wipeOutWorkspace()
