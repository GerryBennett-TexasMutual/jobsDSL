...
job('xray_demo/xray_demo_tmoApps/XRay Demo - agencyCorrespondenceAdmin') {

  	  properties {
        githubProjectUrl('file:///opt/XRayDemo/tmoApps/agencyCorrespondenceAdmin')
    }
  
    scm {
    	git {
          remote {
	  	       url('file:///opt/XRayDemo/tmoApps/agencyCorrespondenceAdmin')
          }
          branch('**/master')
          extensions {
                    wipeOutWorkspace()
